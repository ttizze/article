...
では、どこが重いのか。研究や事例を見ると、**レビュー待ち**と**CI待ち**が大きな待ち時間を生みやすい領域として現れます。大規模なコードレビューの分析では、最初の応答待ちや承認後のマージ待ちといった遅延が明確に計測され、承認からマージまでの時間短縮だけでレビュー速度を大きく改善できることが示唆されています。CI側でも、大規模CIの運用研究でP95の待ち時間を37%削減した報告があり、待ち時間の最適化がボトルネック解消に直結することが示されています。
